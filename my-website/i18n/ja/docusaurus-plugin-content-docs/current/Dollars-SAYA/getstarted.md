...
- **位置**  
  デバイスを体の正面に横向きに置き、カメラを自分に向け、できるだけ顔の高さに合わせてください。  
...
- **向きの調整**  
  ...
  他の向きでキャプチャしたい場合は、コントロールセンターで画面の回転ロックをオフにし、デバイスを希望の向きに回転させてください。
...
1. Dollars SAYA アプリを開き、設定ページに移動します。
